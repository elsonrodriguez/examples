...
def do_inference(hostport, data_dir, concurrency, num_tests):
    """Tests PredictionService with concurrent requests.

    Args:
      hostport: Host:port address of the PredictionService.
      data_dir: The full path of working directory for test data set.
    ...
    test_data_set = input_data.read_data_sets(FLAGS.data_dir, one_hot=True).test
...
def main(_):
    ...
    error_rate = do_inference(FLAGS.server, FLAGS.data_dir,
